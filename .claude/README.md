...
> BMAD-style documentation for AI assistants. Navigate by PURPOSE.
...
| **Schema docs**          | [omnify/](./omnify/)         | Schema changes (auto-generated)   |
...
│   └── frontend.md
│
└── omnify/              # Schema documentation (AUTO-GENERATED)
```
...
| Issue                  | Check                        |
| ---------------------- | ---------------------------- |
| API returns wrong data | `guides/backend/resource.md` |
| Validation fails       | `guides/backend/request.md`  |
...
1. **Schema-First**: Start with `.omnify/schemas/`
