...
| ------------- | -------------------------------------------------------------------- | -------------------- |
| **Required**  | [/guides/backend/architecture.md](../guides/backend/architecture.md) | Design philosophy    |
| **Required**  | [/omnify/schema-guide.md](../omnify/schema-guide.md)                 | Schema syntax        |
| **Reference** | [/omnify/japan-guide.md](../omnify/japan-guide.md)                   | Japanese field types |
| **Reference** | [/guides/backend/service.md](../guides/backend/service.md)           | When to use Service  |
...
Architect Agent:
1. Read /guides/backend/architecture.md
