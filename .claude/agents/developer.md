...
| Task               | Read                                                             |
| ------------------ | ---------------------------------------------------------------- |
| Controller         | [/guides/backend/controller.md](../guides/backend/controller.md) |
| Request validation | [/guides/backend/request.md](../guides/backend/request.md)       |
| API response       | [/guides/backend/resource.md](../guides/backend/resource.md)     |
| Business logic     | [/guides/backend/service.md](../guides/backend/service.md)       |
| OpenAPI docs       | [/guides/backend/openapi.md](../guides/backend/openapi.md)       |

### Frontend Tasks

| Task          | Read                                                                         |
| ------------- | ---------------------------------------------------------------------------- |
| Components    | [/guides/frontend/antd-guide.md](../guides/frontend/antd-guide.md)           |
| API calls     | [/guides/frontend/service-pattern.md](../guides/frontend/service-pattern.md) |
| Data fetching | [/guides/frontend/tanstack-query.md](../guides/frontend/tanstack-query.md)   |
