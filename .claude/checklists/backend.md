...
| Step | Action                | Guide                                               |
| ---- | --------------------- | --------------------------------------------------- |
| 1    | Create schema         | [omnify/schema-guide.md](../omnify/schema-guide.md) |
| 2    | `npx omnify generate` |                                                     |
| 3    | `./artisan migrate`   |                                                     |
| 4    | Model (extend base)   | [README.md](./README.md)                            |
| 5    | Controller (thin)     |                                                     |
| 6    | Resource              |                                                     |
| 7    | Routes                |                                                     |
| 8    | **Tests**             | [testing-guide.md](./testing-guide.md)              |
| 9    | `./artisan test`      |                                                     |
| 10   | OpenAPI               | [openapi-guide.md](./openapi-guide.md)              |
...
> **Full guide**: [openapi-guide.md](./openapi-guide.md)
