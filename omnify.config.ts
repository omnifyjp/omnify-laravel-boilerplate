 ...
 *
 * Package schemas are auto-discovered via composer.json extra.omnify
 * @see docs/package-auto-discovery.md
 */
...
const config: OmnifyConfig = {
  ...
  // Additional schemas are auto-discovered from backend/.omnify-packages.json
  // Generated by omnifyjp/omnify-client-laravel-sso Composer plugin
  ...
  // Schemas go to frontend/src/omnify/schemas, runtime from @famgia/omnify-react
  output: {
    typescript: {
