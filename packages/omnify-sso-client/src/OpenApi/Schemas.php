...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: 'display_name', type: 'string', maxLength: 100, example: 'Administrator'),
...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: 'display_name', type: 'string', maxLength: 100, example: 'Create Projects'),
